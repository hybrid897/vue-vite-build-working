  ...
  <div class="bg-gray-900">
    <main>
      ...
      <div class="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        ...
        <div
          class="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6
      ...
      <div class="mt-32 sm:mt-56">
        ...
        <div class="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl
            class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-300 sm:grid-cols-2
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        ...
        <dl
          class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 text-white sm:mt-20 sm:grid-cols-2
            sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4"
        >
          <div
            v-for="stat in stats"
            :key="stat.id"
      ...
      <div class="relative isolate mt-32 px-6 py-32 sm:mt-56 sm:py-40 lg:px-8">
        <svg
          class="absolute inset-0 -z-10 h-full w-full stroke-white/10
        ...
        <div class="mx-auto max-w-2xl text-center">
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6">
            <a
              class="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100
